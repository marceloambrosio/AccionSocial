...
urlpatterns = [
    ...
    path('expediente_list/', views.expediente_list, name="expediente_list"),
    path('expediente_new/', views.ExpedienteCreateViews.as_view(), name="expediente_new"),
    path('expediente_edit/<int:pk>/', views.ExpedienteUpdateViews.as_view(), name="expediente_edit"),
